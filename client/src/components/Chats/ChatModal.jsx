    ...
    <div className="fixed inset-0 flex items-center justify-center z-50 h-screen w-screen">
      ...
      <div className="bg-neutral-700 text-white p-4 rounded-md relative w-fit min-w-[550px] max-w-2xl h-auto max-h-[100vh] overflow-y-auto">
        <CrossButton
          ...
          onClick={handleClose}
        />
        <div className="mx-2 flex w-fit cursor:pointer">
          <div className="rounded-full mt-2 w-[30%] h-[140px]">
            <div className="rounded-full w-[140px] h-[140px]">
              ...
              <div
                onClick={handleZoom}
                className="absolute inset-0 w-[124px] h-[124px] my-[5.8%] mx-[5.8%] p-4 flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity duration-100 bg-black bg-opacity-50 rounded-full"
              >
                <svg
